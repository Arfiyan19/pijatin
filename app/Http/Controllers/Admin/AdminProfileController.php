...
class AdminProfileController extends Controller
{
    public function index($id)
    {
        ...
        return view('backend.admin.profile.index', compact('user', 'alamat'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.admin.profile.edit', compact('user', 'alamat'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // redirect ke halaman admin profile 
        return redirect()->route('admin.profile', $id)->with('success', 'Profile Berhasil Diupdate');
    }
}
