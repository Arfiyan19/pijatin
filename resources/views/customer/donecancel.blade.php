...
<body>
    ...
    <div class="container-done">
        <img src="{{ asset('frontend/assets/image/wait.png') }}" alt="">
        <div class="text">Pengajuan pembatalan berhasil dilakukan. Kami akan segera mengkonfirmasi pengajuan anda dalam waktu maksimal 1 jam. </div>
        <a class="btn-kirim" href="{{ route('ajukanpembatalan') }}" style="text-decoration: none;">Kembali</a>
    </div>
