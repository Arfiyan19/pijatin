...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <input type="text" name="latitude" id="latitude" class="form-control" style="height: 30px; border-radius: 10px; padding-left: 10px;" placeholder="Latitude" value="{{ $data->alamat[0]->latitude }}">
            <input type="text" name="longitude" id="longitude" class="form-control" style="height: 30px; border-radius: 10px; padding-left: 10px;" placeholder="Longitude" value="{{ $data->alamat[0]->longitude }}">
        </div>
