...
<body>
    ...
    <div class="container2">
        <div class="nav-btn">
            ...
            <a href="{{ route('customers.riwayat-dijadwalkan') }}">
                <div class="btn1 active">Dijadwalkan</div>
            </a>
    ...
    <script>
        function detail(id) {
            // routename customers.riwayat-dijadwalkanID
            window.location.href = "{{ route('customers.riwayat-dijadwalkan') }}" + "/" + id;
            // window.location.href = "/customers/riwayat/dijadwalkan/" + id;
        }
    </script>
