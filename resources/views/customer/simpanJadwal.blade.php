...
<body>
    ...
    <div class="container-tambah">
        <img src="{{ asset('frontend/assets/image/simpanJadwal.png')}}" alt="">
        <div class="txt-simpanJadwal">
            <p>Perubahan jadwal layanan berhasil dilakukan. <br>
                Kami akan segera mengkonfirmasi pengajuan <br> anda dalam waktu maksimal 1 jam.</p>
        </div>
        <div>
            <button type="button" class="btn-simpan">Kembali</button>
        </div>
    </div>
