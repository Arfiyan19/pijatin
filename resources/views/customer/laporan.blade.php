...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/customer/laporan.css') }}">
...
<body>
    ...
    <div class="container-tambah text-start">
        <div>
            <h4>Id pesanan : AV06798</h4>
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Tambahkan link berisi foto atau video, sebagai bukti pendukung jika <br> ada.</label>
            <input type="link" class="form-control" id="exampleFormControlInput1" placeholder="masukan link disini">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Tulis alasan anda dengan jelas dan detail</label>
