...
<body>
    <div class="topbar">
        <div class="content">
            <div class="tittle">
                ...
                <a href="{{ route('customers.riwayat-dijadwalkan') }}"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                        <path d="M19.9492 25.9502L13.0492 19.0502C12.8992 18.9002 12.7932 18.7377 12.7312 18.5627C12.6682 18.3877 12.6367 18.2002 12.6367 18.0002C12.6367 17.8002 12.6682 17.6127 12.7312 17.4377C12.7932 17.2627 12.8992 17.1002 13.0492 16.9502L19.9492 10.0502C20.2242 9.77519 20.5742 9.6377 20.9992 9.6377C21.4242 9.6377 21.7742 9.77519 22.0492 10.0502C22.3242 10.3252 22.4617 10.6752 22.4617 11.1002C22.4617 11.5252 22.3242 11.8752 22.0492 12.1502L16.1992 18.0002L22.0492 23.8502C22.3242 24.1252 22.4617 24.4752 22.4617 24.9002C22.4617 25.3252 22.3242 25.6752 22.0492 25.9502C21.7742 26.2252 21.4242 26.3627 20.9992 26.3627C20.5742 26.3627 20.2242 26.2252 19.9492 25.9502Z" fill="white" />
                    </svg></a>
                <p>Detail Riwayat</p>
                @endif
    ...
    <div class="container-detailriwayat">
        <div class="rectangle">
            <div class="frame-durasi">
                <div class="titl-durasi">Sisa Waktu pembatalan</div>
                <div class="parent-time">
                    <div class="frame-time">
                        <div class="head">02</div>
                        <div class="content">Jam</div>
                    </div>
                    <div class="frame-time">
                        <div class="head">00</div>
                        <div class="content">Menit</div>
                    </div>
                    <div class="frame-time">
                        <div class="head">00</div>
                        <div class="content">Detik</div>
                    </div>
                </div>
                <div class="txt-durasi">Jika durasi habis anda sudah tidak bisa
                    melakukan pembatalan atau pengubahan jadwal</div>
            </div>
            <div class="parent-detail">
                <div class="txt-id">ID : PMSN-0000{{ $pemesanan->id }}</div>
                <div class="card-detail">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td><?php echo "Rp. " . number_format($layanan->harga, 2, ',', '.'); ?></td>
                            </tr>
                            <tr>
                                <td>
                                    @php
                            ...
                            <tr>
                                <td>Status</td>
                                <td><span class="status dijadwalkan">Pending</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="grp-btn">
                <a class="btn-cancel" href="{{ route('ajukanpembatalan') }}" style="text-decoration: none;">Batal</a>
                <div class="btn"><a href="{{ route('notifcustomer') }}" style="text-decoration: none;">Ubah Jadwal</a></div>
            </div>
        </div>
    </div>
</body>
