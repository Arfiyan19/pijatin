...
<body>
    ...
    <div class="container-alamat">
        ...
        <div class="frame-alamat">
            <!-- <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"> -->
            <!-- <div class="card-alamat" style="width: 20%;">
            </div> -->
            <div class="card-alamat" style="width: 100%;">
                <div class="content">
                    <div class="head">
                        <div class="head-tittle2">
                            <div class="txt" style="letter-spacing: 0px;">Nama : {{ $layanan->nama_layanan }}</div>
                            <div class="desc" style="font-size: 14px;">Harga : Rp.{{ number_format($layanan->harga, 2, ',', '.') }}</div>
                            <div class="desc" style="font-size: 14px;">Durasi : {{ $layanan->durasi }} Menit</div>
                        </div>
                        <div class="head-image">
                            <img src="{{ asset('storage/' . $layanan->gambar) }}" alt="foto" style="width: 100px; height: 80px;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        @endforeach
        <a href="{{ route('terapis.layanan.tambah', ['id' => $data->id]) }}" style="text-decoration: none;"><button>+ Tambah Layanan</button></a>
    </div>
    @endif
