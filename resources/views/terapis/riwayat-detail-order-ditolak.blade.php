...
<head>
    ...
    <!-- my style -->
    <link rel="stylesheet" href="{{ asset('frontend/terapist/css/riwayat-detail-order-ditolak.css') }}">
    ...
    <title>Detail Pekerjaan Ditolak</title>
</head>
    ...
    <div class="container">
        ...
        <div class="identitas">
            ...
            <table class="tableidentitas">
                <tr style="color: white;">
                    <th colspan="2" height="50px" style="float: left; font-size:16px">Pekerjaan Tolak</th>
                </tr>
                <tr style="color:white; ">
        ...
        <div class="detailpesan">
            ...
            <table class="table1">
                ...
                <tr>
                    <td align="left" colspan="3">Saya Sedang Sakit</td>
                </tr>
