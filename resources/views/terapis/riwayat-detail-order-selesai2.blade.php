...
<head>
    ...
    <title>Detail Pekerjaan Selesai</title>
</head>

<body>
    <div class="container">
        <div class="topbar">
            <!-- terapis.riwayat-selesai -->
            <a href="{{ route('terapis.riwayat-selesai') }}">
                <img src="{{ asset('frontend/terapist/img/back.png') }}" alt="">
            </a>
            <div class="head">
                <h4>Riwayat Pekerjaan Selesai</h4>
            </div>
        </div>
        <div class="identitas">
            <br>
            <table class="tableidentitas">
                <tr style="color: white; ">
                    <td style="font-size:14px; padding-bottom: 10px;" align="left"><b>Pekerjaan Selesai</b></td>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.btn-mulai').click(function() {
                window.location.href = "{{ route('terapis.riwayat-selesai') }}";
            });
        });
