...
<head>
    ...
    <title>Therapist || Tambah Rekening</title>
...
<body>
    <div class="container">
        <div class="topbar">
            <div class="backbtn">
                <a href="{{ route('terapis.rekening', ['id' => auth()->user()->id]) }}">
        ...
        <div class="content">
            <form id="form" method="post" action="{{ route('terapis.rekening.tambah.post', $user_id) }}">
                @csrf
                <label for="nama" class="form-label">Nama lengkap pemilik rekening<span>*</span></label>
                <div class="input-field">
                    <input type="text" class="form-input" name="nama_pemilik" id="nama" placeholder="masukan nama pemilik">
                    <!-- <div class="error"></div> -->
                ...
                <div class="input-field">
                    <input type="text" class="form-input" name="no_rek" id="kota" placeholder="masukan nomor rekening">
                ...
                <div class="input-field">
                    <input type="text" class="form-input" id="email" name="nama_bank" placeholder="masukan nama bank">
