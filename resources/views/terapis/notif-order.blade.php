...
<body>
    <div class="topbar">
        <a href="http://127.0.0.1:8000/terapis/beranda/notifikasi"><img
                src="{{ asset('frontend/terapist/img/back.png') }}" alt=""></a>
        <div class="head">
    ...
    <div class="popup" id="popup">
        ...
        <div class="content">
            ...
            <form id="form" method="post" action="">
                ...
                <div class="pilihan">
                    <input type="radio" onclick="javascript:alasanlain();" id="btnlain" name="reason"
