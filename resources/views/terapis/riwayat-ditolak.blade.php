    ...
    <div class="container">
        ...
        <div class="content">
            <div class="tab">
                ...
                <a href="{{ route('terapis.riwayat-ditolak') }}" class="active">
                    <div class="tablink bottombar active">tolak</div>
                </a>
            </div>



            <div id="tolak" class=" order" style="padding-top: 10px;">
...
<script>
    ...
    //detail
    function detail(id) {
        // riwayat/ditolak/detail/{id}
        window.location.href = "/terapis/riwayat/ditolak/detail/" + id;
        // alert(id);
    }
</script>
