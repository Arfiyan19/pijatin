        ...
        <div class="card" style="width: 95%;">
            <div class="card shadow mb-4">
                <div class="card-header py-4">
                    <h4 class="m-0 font-weight-bold float-left" style="color: #469D89">Edit Profile</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <form method="post" action="{{ route('superadmin.update.profile', Auth::user()->id) }}"
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <div class="rounded-circle overflow-hidden" style="width: 150px; height: 150px;">
                                            <img id="profile-preview"
                                                src="{{ asset('storage/' . $user->superadmin->foto) }}" width="100%"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="jenis_kelamin" id="jenis_kelamin">
                                                    <option value="Laki-laki"
                                                        {{ $user->superadmin->jenis_kelamin == 'Laki-laki' ? 'selected' : '' }}>
                                                        Laki-laki</option>
                                                    <option value="Perempuan"
                                                        {{ $user->superadmin->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>
                                                        Perempuan</option>
                                                </select>
                                            </div>
                                            <!-- no_telepon -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" name="ktp"
                                                    value="{{ $user->superadmin->foto_ktp }}">
                                                ...
                                                <input type="hidden" name="old_ktp"
                                                    value="{{ $user->superadmin->foto_ktp }}">
                                                <br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="tempat_lahir"
                                                    value="{{ $user->superadmin->tempat_lahir }}">
                                            </div>

                                            <div class="form-group">
                                                <label>Tanggal Lahir</label>
                                                <input type="date" class="form-control" name="tanggal_lahir"
                                                    value="{{ $user->superadmin->tanggal_lahir }}">
                                            </div>
...
@push('scripts')
    ...
    <!-- Tambahkan script berikut ke halaman Anda -->
    <script>
