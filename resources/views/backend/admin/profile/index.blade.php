        ...
        <div class="card" style="width: 95%;">
            <div class="card shadow mb-4">
                <div class="card-header py-4">
                    <h4 class="m-0 font-weight-bold text-primary float-left">Data Profile</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-4">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <a href="{{ route('edit.profile', Auth::user()->id) }}" id="edit" name="edit"
                                        class="btn btn-success btn-sm mt-2"><i class="fas fa-edit"></i> Edit Profile</a>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" disabled="disabled"
                                                value="{{ $user->admins->jenis_kelamin }}">
                                        </div>
                                        <!-- no_telepon -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <a href="{{ asset('storage/foto_ktp/' . $user->admins->foto_ktp) }}"
                                                        data-lightbox="ktp">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" disabled="disabled"
                                                value="{{ $user->admins->tempat_lahir }}, {{ $user->admins->tanggal_lahir }}">
                                        </div>
                                        <!-- provinsi  -->
                                        @if ($alamat == null)
                                            <div class="form-group">
