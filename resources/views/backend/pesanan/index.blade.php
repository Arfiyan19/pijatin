...
@section('main-content')
    ...
    <div class="row justify-content-center align-items-center">
        ...
        <div class="col-md-12" style="display: flex; left: 14px;">
            <a href="#" class="btn" style="background-color: white; color: #469D89;">Transfer</a>
            <a href="#" class="btn" style="background-color: #888888; color: white;">Cash</a>
        </div>
