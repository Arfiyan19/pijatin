...
@section('content')
    <div class="topbar">
        ...
        <div class="toggle">
            ...
            <div class="col">
                <p>Daftar pembayaran transfer</p>
            </div>
        </div>
        ...
        <div style="display: flex; justify-content: space-between;">
            ...
            <div style="width: 20%; position: relative;">
                <form action="{{ route('finance.customer-transaksi.search') }}" method="GET">
                    @csrf
                    <input type="hidden" name="view_name" value="transfer">
    ...
    function confirmDownload() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "{{ route('export.customer.transfer') }}";
            }
        });
        return false;
    }
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <div style="text-align: right;">
                                ...
                                ${data[0].status_pembayaran == 'Pembayaran Sukses' ? 
                                    ...
                                    (data[0].status_pembayaran == 'Batal' ? 
